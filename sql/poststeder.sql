...
CREATE TABLE IF NOT EXISTS `webprosjekt_poststeder` (
  `postnr` smallint(4) unsigned zerofill NOT NULL,
  `poststed` varchar(30) CHARACTER SET utf8 COLLATE utf8_danish_ci DEFAULT NULL,
  PRIMARY KEY (`postnr`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `webprosjekt_poststeder` (`postnr`, `poststed`) VALUES
(0001, 'Oslo'),
(0010, 'Oslo'),
(0014, 'Oslo'),
(0015, 'Oslo'),
