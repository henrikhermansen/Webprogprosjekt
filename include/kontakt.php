...
{
    regEx = /^[a-zA-Z������ .\- ]+@[a-zA-Z������ .\- ]{2,}\.[a-zA-Z]{2,3}$/;
...
function valider_melding()
{
    ...
    document.getElementById("feilmelding").innerHTML = "Du m� skrive noe i meldingsfeltet<br/>";
    return false;
}
...
<h3>Postadresse:</h3>
<p>H�yskolen i Oslo<br/>
    Postboks 4 St. Olavs plass<br/>
    0130 Oslo</p>

<h3>Kontakskjema:</h3>
<p>Ved � fylle ut skjemaet under, tar vi kontakt med deg s� raskt vi kan!</p>
