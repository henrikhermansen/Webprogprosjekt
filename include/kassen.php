...
?>
	...
	<input type="radio" name="frakt" value="dortildor" id="dortildor" style="width:25px;" onClick="oppdaterFrakt(240,<?php echo $totalsum; ?>)"><label for="dortildor">Dør-til-dør (kr. 240,-)</label><br/>
