...
echo "<tr><td></td><td></td><td></td><td></td><td><strong>Sum varer:</strong></td><td>".number_format($ordre->getOrdretotal(),2,',','.')."</td></tr>";
echo "<tr><td></td><td></td><td></td><td></td><td><strong>Frakt:</strong></td><td>120,00</td></tr>";
echo "<tr><td></td><td></td><td></td><td></td><td><strong>Herav MVA (25&#37;):</strong></td><td>".number_format((($ordre->getOrdretotal()+120)*0.2),2,',','.')."</td></tr>";
echo "<tr><td></td><td></td><td></td><td></td><td><strong>TOTALT:</strong></td><td>".number_format(($ordre->getOrdretotal()+120),2,',','.')."</td></tr>";
?>
</table>
<p>
